...
namespace Day15
{
    class PeriodicTableWordsProblem2
    {
        ...
        public PeriodicTableWordsProblem2(string word)
        {
            _originalWord = word;
            _word = word.ToUpper();
        ...
        public void Solve()
        {
            Console.WriteLine("Solution by PeriodicTableWordsProblem2:");
            if (PeriodicTableWords())
            {
                Console.WriteLine($"   Yes, \"{_originalWord}\" can be spelled with the following elements:");
                PrintResult();
            }
            else Console.WriteLine($"   No, \"{_originalWord}\" cannot spelled using elements.");
            Console.WriteLine();
        }
        ...
        private bool PeriodicTableWords()
        {
            ...
            {
                _result.Push(_word.Substring(0, 2));
            ...
            {
                _result.Push(_word.Substring(0, 1));
